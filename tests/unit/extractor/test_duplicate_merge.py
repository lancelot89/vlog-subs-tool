...
def test_duplicate_merge_basic():
    ...
    subtitles = [
        SubtitleItem(index=7, start_ms=16000, end_ms=17200, text="汗だくで帰宅しました、シャワー浴びてきたのでスッキリ凍らせた水持って出かけたけど真夏の外出は危険だと思った"),
        SubtitleItem(index=8, start_ms=18000, end_ms=19200, text="汗だくで帰宅しました、シャワー浴びてきたのでスッキリ凍らせた水持って出かけたけど真夏の外出は危険だと思った"),
        SubtitleItem(index=9, start_ms=20000, end_ms=21200, text="汗だくで帰宅しました、シャワー浴びてきたのでスッキリ凍らせた水持って出かけたけど真夏の外出は危険だと思った"),
        SubtitleItem(index=10, start_ms=22000, end_ms=23200, text="汗だくで帰宅しました、シヤワー浴びてきたのでスッキリ凍らせた水持って出かけたけど真夏の外出は危険だと思った"),  # "シヤワー"に変更
        SubtitleItem(index=11, start_ms=24000, end_ms=25200, text="汗だくで帰宅しました、シヤワー浴びてきたのでスッキリ凍らせた水持って出かけたけど真夏の外出は危険だと思った"),
        SubtitleItem(index=12, start_ms=26000, end_ms=27200, text="汗だくで帰宅しました、シャワー浴びてきたのでスッキリ凍らせた水持って出かけたけど真夏の外出は危険だと思った"),
    ]
...
def test_no_duplicates():
    ...
    settings = {'similarity_threshold': 0.90, 'min_duration_sec': 1.2, 'max_gap_sec': 0.5}
    processor = ExtractionProcessor(settings)
