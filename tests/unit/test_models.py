...
from app.core.models import Project, ProjectSettings, QCResult, SubtitleItem
...
class TestSubtitleItem:
    ...
    def test_init(self):
        """初期化テスト"""
        item = SubtitleItem(index=1, start_ms=1000, end_ms=3000, text="テストテキスト")
    ...
    def test_from_dict(self):
        """from_dict()メソッドのテスト"""
        data = {"index": 2, "start_ms": 2000, "end_ms": 4000, "text": "テスト2"}
...
class TestProjectSettings:
    ...
    def test_to_dict_from_dict(self):
        """辞書変換のテスト"""
        settings = ProjectSettings(
            ocr_engine="tesseract_jpn", fps_sample=2.0, similarity_threshold=0.95
        )
